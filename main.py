        ...
        with chat_placeholder.container():
            if st.session_state.chat_history:
                ...
                for chat in st.session_state.chat_history:
                    ...
                    user_chat = f"<div style='text-align: right;background-color: #22303c;margin: 5px; border-radius: 8px; padding: 10px;margin-left: 1vw;'> {chat['question']}</div>"
                    assistant_chat = f"<div style='text-align: left;background-color: #22303c;margin: 5px; border-radius: 8px; padding: 10px;margin-right: 1vw;'> {chat['answer']}</div>"
